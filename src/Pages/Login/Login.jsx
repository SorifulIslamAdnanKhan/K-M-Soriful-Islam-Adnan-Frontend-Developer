...
const Login = () => {
    return (
        <div>
            <h2 className='text-center text-xl p-2 font-bold'>Please Login</h2>
            <form className='h-[400px] md:w-2/6 mx-auto flex justify-center items-center flex-col p-4'>
                ...
                <p className='text-lg mt-4'>Don't have an account. Please <Link to='/signup' className='text-blue-400'>Register</Link> here.</p>
            </form>
        </div>
    );
};
